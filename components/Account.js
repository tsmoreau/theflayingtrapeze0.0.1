    ...
    return (
      <div>
        {hasMetaMaskOrWeb3Available ? (
          <button
            className="bg-gradient-to-br bg-gradient-to-br from-purple-600 via-blue-500 to-green-400 hover:from-indigo-600 hover:via-pink1-600 hover:to-red-600 inline-flex items-center px-9 py-2 mt-4 lg:-mr-6 font-normal text-white   active:bg-blue-600 rounded-full text-sm md:mt-0"
            onClick={() => {
              setConnecting(true);
