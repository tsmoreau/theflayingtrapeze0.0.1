        ...
        <div className="transform -translate-y-3 lg:translate-x-16">
          <div className="  flex flex-col justify-end">
            ...
            <div className=" flex inline-flex justify-center">
              <a
                className="ml-2 inline-flex items-center px-8 py-1 mt-4 font-normal bg-gradient-to-br from-purple-600 via-blue-500 to-green-400 hover:from-indigo-600 hover:via-pink1-600 hover:to-red-600 inline-flex items-center py-3 mt-4 font-normal text-white   active:bg-blue-600 rounded-md text-md md:mt-0"
                href="/market"
              >
