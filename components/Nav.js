          ...
          <div class=" mx-auto  w-full px-4 py-1 flex justify-between items-center  ">
            ...
            <div class="lg:hidden">
              <button
                ...
                type="button"
                className="bg-gradient-to-br from-purple-600 via-blue-500 to-green-400 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
